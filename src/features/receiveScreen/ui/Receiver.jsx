    ...
    iceServers: [
        {
            urls: [
                ...
                //'turns:10.47.0.221:5349?transport=tcp',
            ],
            username: 'test',
            credential: 'test',
        },
...
// const WEBRTC_CONFIG = {
//     iceServers: [
//         // Сначала STUN для обнаружения (опционально, но лучше добавить)
//         {
//             urls: 'stun:10.47.0.221:3478'  // Используйте IP, не DNS
//         },
//         // Основные TURN серверы
//         {
//             urls: [
//                 'turn:10.47.0.221:3478?transport=udp',
//                 'turn:10.47.0.221:3478?transport=tcp',
//                 // УБЕРИТЕ turns - у вас отключен TLS
...
//         },
//     ],
//     iceTransportPolicy: 'relay',  // Оставляем relay
//     iceCandidatePoolSize: 10,     // Увеличиваем с 0 до 10
//     bundlePolicy: 'max-bundle',
//     rtcpMuxPolicy: 'require',
//     // Дополнительные опции для стабильности
//     sdpSemantics: 'unified-plan',
//     // Важно для видео потоков
